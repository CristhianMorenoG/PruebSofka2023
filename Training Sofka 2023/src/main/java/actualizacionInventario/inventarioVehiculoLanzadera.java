...
public class inventarioVehiculoLanzadera extends NaveEspacial {


    public static void entradanaveTipoLanzadera() {
        ...
        navesRepositorio.insertVehiculoLanzadera(new VehiculoLanzadera());
